    ...
    <el-card class="main-card">
        ...
        <div class="operation-container">
            ...
            <div style="margin-left:auto">
                <el-button type="text" size="small" icon="el-icon-delete" style="margin-right:1rem"
                           @click="checkDelete">
                    回收站
                </el-button>
                <el-input v-model="keywords" prefix-icon="el-icon-search" size="small"
                          placeholder="请输入相册名" style="width:200px" @keyup.enter.native="searchAlbums"/>
                <el-button type="primary" size="small" icon="el-icon-search"
                           style="margin-left:1rem" @click="searchAlbums">
                    搜索
                </el-button>
            </div>
        </div>
        ...
        <el-pagination :hide-on-single-page="true" class="pagination-container" @size-change="sizeChange"
                       ...
                       :total="count" layout="prev, pager, next"/>
        <!-- 新增模态框 -->
        <el-dialog :visible.sync="addOrEdit" width="35%" top="10vh">
            ...
            <el-form label-width="80px" size="medium" :model="albumForum">
                ...
                <el-form-item label="相册封面">
                    <el-upload class="upload-cover" drag :show-file-list="false" :before-upload="beforeUpload"
                               action="/api/admin/photos/albums/cover" multiple :on-success="uploadCover">
