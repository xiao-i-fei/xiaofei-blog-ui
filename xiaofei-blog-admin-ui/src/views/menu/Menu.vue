    ...
    <el-card class="main-card">
        ...
        <div class="operation-container">
            ...
            <div style="margin-left:auto">
                <el-input v-model="keywords" prefix-icon="el-icon-search" size="small"
                          placeholder="请输入菜单名" style="width:200px" @keyup.enter.native="listMenus"/>
        ...
        <el-table v-loading="loading" :data="menuList" row-key="id"
            ...
            <el-table-column prop="isHidden" label="隐藏" align="center" width="80">
                <template slot-scope="scope">
                    <el-switch v-model="scope.row.isHidden" active-color="#13ce66" inactive-color="#F4F4F5"
            ...
            <el-form label-width="80px" size="medium" :model="menuForm">
                ...
                <el-form-item label="菜单图标">
                    <el-popover placement="bottom-start" width="300" trigger="click">
                        ...
                        <el-input :prefix-icon="'iconfont ' + menuForm.icon" slot="reference" v-model="menuForm.icon"
                                  style="width:220px"/>
                    </el-popover>
                </el-form-item>
                <!-- 组件路径 -->
