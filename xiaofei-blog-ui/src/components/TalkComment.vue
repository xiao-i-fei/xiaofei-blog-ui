    ...
    <div>
        ...
        <div class="comment-wrapper">
            <div style="display:flex;width:100%">
                <v-avatar size="36">
                    <img alt="" v-if="this.$store.state.avatar" :src="this.$store.state.avatar"/>
                    <img alt="" v-else :src="this.$store.state.blogInfo.websiteConfig.touristAvatar"/>
                </v-avatar>
                <div style="width:100%" class="ml-3">
                    <div class="comment-input">
                        <textarea class="comment-textarea" v-model="commentContent"
                                  placeholder="留下点什么吧..." auto-grow dense/>
                    </div>
                    <!-- 操作按钮 -->
                    <div class="emoji-container">
                        <span :class="chooseEmoji ? 'emoji-btn-active' : 'emoji-btn'"
            ...
            <div class="comment-wrapper" v-for="(item, index) of commentList" :key="item.id">
                ...
                <div class="comment-meta">
                    ...
                    <div style="display:flex" v-for="reply of item.replyDTOList" :key="reply.id">
                        ...
                        <div class="reply-meta">
                            ...
                            <div class="comment-user">
                                ...
                                <v-icon size="20" color="#ffa51e" v-if="reply.userId == 1">mdi-check-decagram</v-icon>
                            </div>
                            <!-- 信息 -->
                            <div class="comment-info">
                                <!-- 发表时间 -->
                    ...
                    <div class="mb-3" style="font-size:0.75rem;color:#6d757a" v-show="item.replyCount > 3" ref="check">
                        ...
                        <span style="color:#00a1d6;cursor:pointer" @click="checkReplies(index, item)">点击查看</span>
                    </div>
                    <!-- 回复分页 -->
                    <div class="mb-3" style="font-size:0.75rem;color:#222;display:none" ref="paging">
                        ...
                        <paging ref="page" :totalPage="Math.ceil(item.replyCount / 5)" :index="index"
                                :commentId="item.id" @changeReplyCurrent="changeReplyCurrent"/>
                    </div>
                    <!-- 回复框 -->
