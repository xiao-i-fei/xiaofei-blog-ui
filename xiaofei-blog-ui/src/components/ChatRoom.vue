<template>
    <div>
        ...
        <div class="chat-container animated bounceInUp" v-show="isShow" @click="closeAll"
            ...
            <!-- 标题 -->
            <div class="header">
                <img alt="" width="32" height="32" style="border-radius: 50%"
                     src="https://xiaofei-mall.oss-cn-beijing.aliyuncs.com/%E9%80%9A%E7%94%A8%E5%9B%BE%E7%89%87/%E5%A4%B4%E5%83%8F/IMG_20220401_113118.jpg"/>
        ...
        <div class="chat-btn" @click="open">
            ...
            <img alt="" width="100%" height="100%" style="border-radius: 50%"
                 src="https://xiaofei-mall.oss-cn-beijing.aliyuncs.com/%E9%80%9A%E7%94%A8%E5%9B%BE%E7%89%87/%E5%A4%B4%E5%83%8F/IMG_20220401_113118.jpg"/>
        </div>
    </div>
</template>
