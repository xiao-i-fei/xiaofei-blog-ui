<template>
    <el-card class="main-card">
        ...
        <div class="operation">
            ...
            <el-button type="success" @click="updatePhotoDelete(null)" :disabled="selectPhotoIdList.length == 0"
        ...
        <el-pagination :hide-on-single-page="true" class="pagination-container" @size-change="sizeChange"
                       @current-change="currentChange" :current-page="current"
                       :page-size="size" :total="count" layout="prev, pager, next"/>
        <!-- 批量删除对话框 -->
